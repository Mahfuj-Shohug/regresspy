...
To down load the latest version of this project located in [this GiHub repository](https://github.com/Mahfuj-Shohug/regresspy/tree/Mahfuj-Shohug), execute the following command from the command line:
